<template>
	<view class="content w-100">
		...
		<view class="header flex column">
			...
			<text class="font-size-big m-l-15 uni-bold m-b-20">
				{{$t('403 No Authorization')}}
			</text>
		</view>
		<view class="data flex column">
			<view class="font-size-big uni-bold m-b-20">{{$t('403_TITLE')}}</view>
			<text class="font-size-normal">{{$t("403_DESCRIPTION")}}</text>
			...
			<button class="btn m-t-50 m-b-50" @click="goBack">{{$t("Back Page")}}</button>
		</view>
	</view>
</template>
