...
<script>
	...
	export default{
		...
		methods:{
			...
			gotoReserve(){
				if(uni.getStorageSync("userInfo") == undefined || uni.getStorageSync("userInfo") == null || uni.getStorageSync("userInfo") == "")
				{
					uni.navigateTo({
					...
					{
						if(userInfo.webportal.confirmed_status == 2 && userInfo.webportal.protal_type != "company" && userInfo.webportal.portal_user_type != 1) {
							uni.navigateTo({
